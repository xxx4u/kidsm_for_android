...
public class CalendarAdapter extends BaseAdapter {
	...
	public static List<String> previousDayString;
	private View previousView;

	public CalendarAdapter(Context c, GregorianCalendar monthCalendar, ArrayList<CalendarEvent> eventList) {
		CalendarAdapter.dayString = new ArrayList<String>();
		CalendarAdapter.previousDayString = new ArrayList<String>();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) { // if it's not recycled, initialize some
			...
			v = vi.inflate(R.layout.schedule_calendar_item, null);
		}
		...
		if (dayString.get(position).equals(currentDateString)) {
			...
			v.setBackgroundResource(R.drawable.schedule_calendar_cell);
		}
		...
		if (date.length() > 0 && eventList != null ) {
			int counter = 0;
			ArrayList<CalendarEvent> eventOnSameDate = new ArrayList<CalendarEvent>();
			for( int i = 0; i < eventList.size(); i++ ) {
				if( eventList.get(i).startDate.equals(date) ) {
					eventOnSameDate.add(eventList.get(i));
					counter++;
				}
			}
			if(eventOnSameDate.size() != 0 ) {
				...
				if(eventOnSameDate.size() == 1 ) {
					...
					int scheduleCounter = 0, birthdayCounter = 0;
					for(int i = 0; i < eventOnSameDate.size(); i++) {
						switch( eventOnSameDate.get(i).type ) {
						case 0:
							scheduleCounter++;
							break;
						case 1:
	...
	public View setSelected(View view) {
		if (previousView != null) {
			previousView.setBackgroundResource(R.drawable.schedule_calendar_cell);
		}
		previousView = view;
...
//	public static List<String> getCalendarFromCurrentMonth(int gapIndex) {
