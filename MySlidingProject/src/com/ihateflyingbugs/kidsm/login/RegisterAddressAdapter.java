...
public class RegisterAddressAdapter extends BaseAdapter {
	LayoutInflater mInflater;
	ArrayList<RegisterAddressItem> arSrc;
	Context context;
	
	public RegisterAddressAdapter(Context context, ArrayList<RegisterAddressItem> arItem) {
	...
	public RegisterAddressItem getItem(int position) {
