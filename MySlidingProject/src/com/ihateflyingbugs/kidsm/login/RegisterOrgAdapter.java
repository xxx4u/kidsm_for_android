...
public class RegisterOrgAdapter extends BaseAdapter {
	LayoutInflater mInflater;
	//ArrayList<RegisterOrgItem> realArSrc;
	ArrayList<RegisterOrgItem> arSrc;
	Context context;
	
	public RegisterOrgAdapter(Context context, ArrayList<RegisterOrgItem> arItem) {
	...
	public RegisterOrgItem getItem(int position) {
